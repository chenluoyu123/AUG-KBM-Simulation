...
if inputgyro['RADIAL_PROFILE_METHOD']==3: # wil need to get the kinetic profiles from input.gacode
    inputs_node_names={'input.gyro':OMFITgacode,'input.gacode':OMFITgacode}
else:
