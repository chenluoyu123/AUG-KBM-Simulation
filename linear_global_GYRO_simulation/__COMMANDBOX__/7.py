...
# updated version,which has higher energy_grid and energy_max
n_cgyro_update=array([3,4,5,6,8,10,12])
omega_cgyro_update=array([ 2.38275  ,  -0.67615  ,  -0.90548667, -0.802295 ,  -0.973404 ,  -1.36420833, -1.72106667])
gamma_cgyro_update=array([0.084108 ,  0.14566 ,   0.14539667, 0.13919 ,   0.11815  ,  0.10092167, 0.085215  ])
...
plot(n_cgyro_update[1:],omega_cgyro_update[1:],'-ko',linewidth=lw,label='GYRO-Global-Update')
...
plot(n_cgyro_update[1:],gamma_cgyro_update[1:],'-ko',linewidth=lw,label='GYRO-Global-Update')
